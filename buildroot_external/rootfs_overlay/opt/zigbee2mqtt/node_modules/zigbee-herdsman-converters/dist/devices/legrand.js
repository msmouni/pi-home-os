...
exports.definitions = [
    ...
    },
    {
        ...
        fromZigbee: [fz.legrand_scenes, legrand_1.fzLegrand.legrand_master_switch_center, fz.battery, legrand_1.fzLegrand.stop_poll_on_checkin],
        toZigbee: [],
        extend: [legrand_1.legrandExtend.addLegrandDevicesCluster()],
    ...
    },
    {
        ...
        ota: true,
        meta: { battery: { voltageToPercentage: { min: 2500, max: 3000 } } },
        fromZigbee: [fz.legrand_scenes, fz.battery, legrand_1.fzLegrand.legrand_master_switch_center],
        toZigbee: [],
        extend: [legrand_1.legrandExtend.addLegrandDevicesCluster()],
        exposes: [e.battery(), e.action(["enter", "leave", "sleep", "wakeup", "center"])],
        configure: async (device, coordinatorEndpoint) => {
    ...
    },
    {
        ...
        ota: true,
        fromZigbee: [legrand_1.fzLegrand.cluster_fc01, legrand_1.fzLegrand.legrand_pilot_wire_mode, fz.on_off, fz.electrical_measurement, fz.power_on_behavior],
        toZigbee: [
            legrand_1.tzLegrand.legrand_device_mode,
            legrand_1.tzLegrand.legrand_pilot_wire_mode,
            tz.on_off,
