...
exports.definitions = [
    {
        ...
        ota: true,
        fromZigbee: [fz.identify, fz.K4003C_binary_input, legrand_1.fzLegrand.cluster_fc01],
        toZigbee: [legrand_1.tzLegrand.K4003C_state, legrand_1.tzLegrand.led_mode, legrand_1.tzLegrand.identify],
    ...
    },
    {
        ...
        vendor: "BTicino",
        extend: [legrand_1.legrandExtend.addLegrandDevicesCluster(), m.onOff(), m.electricityMeter({ cluster: "electrical" })],
        fromZigbee: [fz.identify, legrand_1.fzLegrand.cluster_fc01],
        toZigbee: [legrand_1.tzLegrand.legrand_device_mode, legrand_1.tzLegrand.identify],
        exposes: [
            e
