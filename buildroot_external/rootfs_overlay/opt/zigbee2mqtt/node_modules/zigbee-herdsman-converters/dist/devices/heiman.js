...
const heimanExtend = {
    ...
    heimanClusterSpecial: () => m.deviceAddCustomCluster("heimanClusterSpecial", {
        ...
        attributes: {
            ...
            sensorFaultState: { name: "sensorFaultState", ID: 0x0002, type: zigbee_herdsman_1.Zcl.DataType.BITMAP16, write: true },
            sensorPollutionLevel: { name: "sensorPollutionLevel", ID: 0x0003, type: zigbee_herdsman_1.Zcl.DataType.UINT8, write: true },
            sensorSensitivityLevel: { name: "sensorSensitivityLevel", ID: 0x0004, type: zigbee_herdsman_1.Zcl.DataType.ENUM8, write: true },
            ...
            smokeUnit: { name: "smokeUnit", ID: 0x1008, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
            remoteSelfTest: { name: "remoteSelfTest", ID: 0x1009, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
            temperatureOffset: { name: "temperatureOffset", ID: 0x100d, type: zigbee_herdsman_1.Zcl.DataType.INT16 },
            rebootedCount: { name: "rebootedCount", ID: 0x0019, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
            rejoinedCount: { name: "rejoinedCount", ID: 0x001a, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
            reportedPackages: { name: "reportedPackages", ID: 0x001b, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
            // wifi classes
            wifiSsid: { name: "wifiSsid", ID: 0x2000, type: zigbee_herdsman_1.Zcl.DataType.CHAR_STR },
            wifiPassword: { name: "wifiPassword", ID: 0x2001, type: zigbee_herdsman_1.Zcl.DataType.CHAR_STR },
            wifiSsidCandidate: { name: "wifiSsidCandidate", ID: 0x2002, type: zigbee_herdsman_1.Zcl.DataType.CHAR_STR },
            wifiPasswordCandidate: { name: "wifiPasswordCandidate", ID: 0x2003, type: zigbee_herdsman_1.Zcl.DataType.CHAR_STR },
            pictureQuantity: { name: "pictureQuantity", ID: 0x2004, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
            pictureQuality: { name: "pictureQuality", ID: 0x2005, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
            ...
            sensorArmed: { name: "sensorArmed", ID: 0x200b, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
            ...
            wifiRssi: { name: "wifiRssi", ID: 0x200e, type: zigbee_herdsman_1.Zcl.DataType.INT8 },
    ...
    },
    {
        ...
        extend: [
            ...
            m.numeric({
                ...
                valueMax: 20,
                cluster: "heimanClusterSpecial",
                attribute: { ID: 0x2004, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
            ...
            m.numeric({
                ...
                valueMax: 100,
                cluster: "heimanClusterSpecial",
                attribute: { ID: 0x2005, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
            ...
            m.binary({
                ...
                valueOff: ["Disarmed", 0],
                cluster: "heimanClusterSpecial",
                attribute: { ID: 0x200b, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                description: "armed",
                access: "ALL",
            }),
            m.enumLookup({
                ...
                cluster: "heimanClusterSpecial",
                attribute: { ID: 0x200c, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
            ...
            m.enumLookup({
                ...
                lookup: { unconfigurated: 0, unconnected: 1, connected: 2, connection_timeout: 3 },
                cluster: "heimanClusterSpecial",
                attribute: { ID: 0x200d, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
            ...
            m.enumLookup({
                ...
                cluster: "heimanClusterSpecial",
                attribute: { ID: 0x200f, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
            ...
            m.enumLookup({
                ...
                lookup: { unconfigurated: 0, unconnected: 1, connected: 2, api_timeout: 3 },
                cluster: "heimanClusterSpecial",
                attribute: { ID: 0x2010, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
            ...
            m.enumLookup({
                ...
                cluster: "heimanClusterSpecial",
                attribute: { ID: 0x2013, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                description: "wifi candidate status",
                access: "STATE_GET",
            }),
            m.numeric({
                ...
                valueMax: 127,
                cluster: "heimanClusterSpecial",
                attribute: { ID: 0x200e, type: zigbee_herdsman_1.Zcl.DataType.INT8 },
    ...
    },
    {
        ...
        extend: [
            ...
            m.enumLookup({
                ...
                cluster: "heimanClusterSpecial",
                attribute: { ID: 0x0018, type: zigbee_herdsman_1.Zcl.DataType.ENUM8 },
            ...
            m.enumLookup({
                ...
                cluster: "heimanClusterSpecial",
                attribute: { ID: 0x0017, type: zigbee_herdsman_1.Zcl.DataType.ENUM8 },
            ...
            m.enumLookup({
                ...
                cluster: "heimanClusterSpecial",
                attribute: { ID: 0x1007, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
            ...
            m.enumLookup({
                ...
                cluster: "heimanClusterSpecial",
                attribute: { ID: 0x0012, type: zigbee_herdsman_1.Zcl.DataType.ENUM8 },
            ...
            m.numeric({
                ...
                valueMax: 1500,
                cluster: "heimanClusterSpecial",
                attribute: { ID: 0x100d, type: zigbee_herdsman_1.Zcl.DataType.INT16 },
            ...
            m.numeric({
                ...
                valueMax: 60000,
                cluster: "heimanClusterSpecial",
                attribute: { ID: 0x001b, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
            ...
            m.numeric({
                ...
                valueMax: 60000,
                cluster: "heimanClusterSpecial",
                attribute: { ID: 0x001a, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
            ...
            m.numeric({
                ...
                valueMax: 60000,
                cluster: "heimanClusterSpecial",
                attribute: { ID: 0x0019, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
