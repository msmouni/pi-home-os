    ...
    namron_panelheater: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            if (data[0x100a] !== undefined) {
                // Hysteresis
                const value = utils.precisionRound(data[0x100a], 2) / 10;
                if (isPro) {
...
exports.definitions = [
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint) => {
            ...
            try {
                await endpoint.read("hvacThermostat", [0x1000, 0x1001, 0x1009, 0x100a, 0x100b, 0x100c, 0x2006, 0x2007, 0x2008, 0x2009], sunricherManufacturer);
            }
            catch {
