    ...
    },
    {
        ...
        extend: [
            m.deviceAddCustomCluster("3rVirationSpecialcluster", {
                ...
                manufacturerCode: 0x1233,
                attributes: {
                    coolDownTime: { name: "coolDownTime", ID: 0x0004, type: zigbee_herdsman_1.Zcl.DataType.UINT16, write: true, max: 0xffff },
                    xAxis: { name: "xAxis", ID: 0x0001, type: zigbee_herdsman_1.Zcl.DataType.INT16, write: true, min: -32768 },
                    yAxis: { name: "yAxis", ID: 0x0002, type: zigbee_herdsman_1.Zcl.DataType.INT16, write: true, min: -32768 },
                    zAxis: { name: "zAxis", ID: 0x0003, type: zigbee_herdsman_1.Zcl.DataType.INT16, write: true, min: -32768 },
                },
                commands: {},
                commandsResponse: {},
            }),
