...
export declare const namron_thermostat: Fz.Converter<"hvacThermostat", undefined, ["attributeReport", "readResponse"]>;
export declare const namron_hvac_user_interface: Fz.Converter<"hvacUserInterfaceCfg", undefined, ["attributeReport", "readResponse"]>;
export declare const ias_smoke_alarm_1_develco: Fz.Converter<"ssIasZone", undefined, "commandStatusChangeNotification">;
export declare const tuya_doorbell_button: Fz.Converter<"ssIasZone", undefined, "commandStatusChangeNotification">;
export declare const DTB190502A1: Fz.Converter<"genOnOff", undefined, ["attributeReport", "readResponse"]>;
export declare const ZigUP: Fz.Converter<"genOnOff", undefined, ["attributeReport", "readResponse"]>;
export declare const ts0216_siren: Fz.Converter<"ssIasWd", undefined, ["attributeReport", "readResponse"]>;
export declare const WSZ01_on_off_action: Fz.Converter<65029, undefined, "attributeReport">;
export declare const livolo_switch_state: Fz.Converter<"genOnOff", undefined, ["attributeReport", "readResponse"]>;
export declare const livolo_socket_state: Fz.Converter<"genPowerCfg", undefined, ["raw"]>;
export declare const livolo_new_switch_state: Fz.Converter<"genPowerCfg", undefined, ["raw"]>;
export declare const livolo_new_switch_state_2gang: Fz.Converter<"genPowerCfg", undefined, ["raw"]>;
export declare const livolo_new_switch_state_4gang: Fz.Converter<"genPowerCfg", undefined, ["raw"]>;
export declare const livolo_curtain_switch_state: Fz.Converter<"genPowerCfg", undefined, ["raw"]>;
export declare const livolo_dimmer_state: Fz.Converter<"genPowerCfg", undefined, ["raw"]>;
export declare const livolo_cover_state: Fz.Converter<"genPowerCfg", undefined, ["raw"]>;
export declare const livolo_hygrometer_state: Fz.Converter<"genPowerCfg", undefined, ["raw"]>;
export declare const livolo_illuminance_state: Fz.Converter<"genPowerCfg", undefined, ["raw"]>;
export declare const livolo_pir_state: Fz.Converter<"genPowerCfg", undefined, ["raw"]>;
export declare const easycode_action: Fz.Converter<"closuresDoorLock", undefined, "raw">;
export declare const easycodetouch_action: Fz.Converter<"closuresDoorLock", undefined, "raw">;
export declare const livolo_switch_state_raw: Fz.Converter<"genPowerCfg", undefined, ["raw"]>;
...
export declare const keypad20states: Fz.Converter<"genOnOff", undefined, ["readResponse", "attributeReport"]>;
export declare const keypad20_battery: Fz.Converter<"genPowerCfg", undefined, ["readResponse", "attributeReport"]>;
export declare const plaid_battery: Fz.Converter<"genPowerCfg", undefined, ["readResponse", "attributeReport"]>;
export declare const heiman_ir_remote: Fz.Converter<"heimanSpecificInfraRedRemote", HeimanSpecificInfraRedRemoteCluster, [
    "commandStudyKeyRsp",
    "commandCreateIdRsp",
    "commandGetIdAndKeyCodeListRsp"
]>;
export declare const meazon_meter: Fz.Converter<"seMetering", undefined, ["attributeReport", "readResponse"]>;
...
export declare const restorable_brightness: Fz.Converter<"genLevelCtrl", undefined, ["attributeReport", "readResponse"]>;
export declare const ewelink_action: Fz.Converter<"genOnOff", undefined, ["commandOn", "commandOff", "commandToggle"]>;
export declare const diyruz_contact: Fz.Converter<"genOnOff", undefined, ["attributeReport", "readResponse"]>;
export declare const diyruz_rspm: Fz.Converter<"genOnOff", undefined, ["attributeReport", "readResponse"]>;
export declare const K4003C_binary_input: Fz.Converter<"genBinaryInput", undefined, ["attributeReport", "readResponse"]>;
export declare const enocean_ptm215z: Fz.Converter<"greenPower", undefined, ["commandNotification", "commandCommissioningNotification"]>;
export declare const enocean_ptm215ze: Fz.Converter<"greenPower", undefined, ["commandNotification", "commandCommissioningNotification"]>;
export declare const enocean_ptm216z: Fz.Converter<"greenPower", undefined, ["commandNotification", "commandCommissioningNotification"]>;
export declare const diyruz_freepad_clicks: Fz.Converter<"genMultistateInput", undefined, ["readResponse", "attributeReport"]>;
export declare const kmpcil_res005_occupancy: Fz.Converter<"genBinaryInput", undefined, ["attributeReport", "readResponse"]>;
export declare const kmpcil_res005_on_off: Fz.Converter<"genBinaryOutput", undefined, ["attributeReport", "readResponse"]>;
export declare const byun_smoke_false: Fz.Converter<"pHMeasurement", undefined, ["attributeReport"]>;
export declare const byun_smoke_true: Fz.Converter<"ssIasZone", undefined, ["commandStatusChangeNotification"]>;
export declare const byun_gas_false: Fz.Converter<1034, undefined, ["raw"]>;
export declare const byun_gas_true: Fz.Converter<"ssIasZone", undefined, ["commandStatusChangeNotification"]>;
export declare const legrand_binary_input_moving: Fz.Converter<"genBinaryInput", undefined, ["attributeReport", "readResponse"]>;
export declare const legrand_binary_input_on_off: Fz.Converter<"genBinaryInput", undefined, ["attributeReport", "readResponse"]>;
export declare const bticino_4027C_binary_input_moving: Fz.Converter<"genBinaryInput", undefined, ["attributeReport", "readResponse"]>;
export declare const legrand_scenes: Fz.Converter<"genScenes", undefined, "commandRecall">;
export declare const legrand_power_alarm: Fz.Converter<"haElectricalMeasurement", undefined, ["attributeReport", "readResponse"]>;
export declare const legrand_greenpower: Fz.Converter<"greenPower", undefined, ["commandNotification", "commandCommissioningNotification"]>;
...
export declare const qlwz_letv8key_switch: Fz.Converter<"genMultistateInput", undefined, ["attributeReport", "readResponse"]>;
...
export declare const heiman_hcho: Fz.Converter<"msFormaldehyde", undefined, ["attributeReport", "readResponse"]>;
export declare const heiman_air_quality: Fz.Converter<"heimanSpecificAirQuality", HeimanSpecificAirQualityCluster, ["attributeReport", "readResponse"]>;
export declare const scenes_recall_scene_65024: Fz.Converter<65024, undefined, ["raw"]>;
export declare const adeo_button_65024: Fz.Converter<65024, undefined, ["raw"]>;
export declare const color_stop_raw: Fz.Converter<"lightingColorCtrl", undefined, ["raw"]>;
...
export declare const STS_PRS_251_presence: Fz.Converter<"genBinaryInput", undefined, ["attributeReport", "readResponse"]>;
export declare const heiman_scenes: Fz.Converter<"heimanSpecificScenes", HeimanSpecificScenesCluster, [
    "commandAtHome",
    "commandGoOut",
    "commandCinema",
    "commandRepast",
...
export declare const javis_lock_report: Fz.Converter<"genBasic", undefined, "attributeReport">;
export declare const diyruz_freepad_config: Fz.Converter<"genOnOffSwitchCfg", undefined, ["readResponse"]>;
export declare const diyruz_geiger: Fz.Converter<"msIlluminanceMeasurement", undefined, ["attributeReport", "readResponse"]>;
export declare const diyruz_geiger_config: Fz.Converter<"msIlluminanceLevelSensing", undefined, "readResponse">;
export declare const diyruz_airsense_config_co2: Fz.Converter<"msCO2", undefined, "readResponse">;
export declare const diyruz_airsense_config_temp: Fz.Converter<"msTemperatureMeasurement", undefined, "readResponse">;
export declare const diyruz_airsense_config_pres: Fz.Converter<"msPressureMeasurement", undefined, "readResponse">;
export declare const diyruz_airsense_config_hum: Fz.Converter<"msRelativeHumidity", undefined, "readResponse">;
export declare const diyruz_zintercom_config: Fz.Converter<"closuresDoorLock", undefined, ["attributeReport", "readResponse"]>;
export declare const CC2530ROUTER_led: Fz.Converter<"genOnOff", undefined, ["attributeReport", "readResponse"]>;
export declare const CC2530ROUTER_meta: Fz.Converter<"genBinaryValue", undefined, ["attributeReport", "readResponse"]>;
export declare const KAMI_contact: Fz.Converter<"ssIasZone", undefined, ["raw"]>;
export declare const KAMI_occupancy: Fz.Converter<"msOccupancySensing", undefined, ["raw"]>;
export declare const DNCKAT_S00X_buttons: Fz.Converter<"genOnOff", undefined, ["attributeReport", "readResponse"]>;
export declare const hue_motion_sensitivity: Fz.Converter<"msOccupancySensing", undefined, ["attributeReport", "readResponse"]>;
export declare const hue_motion_led_indication: Fz.Converter<"genBasic", undefined, ["attributeReport", "readResponse"]>;
export declare const hue_wall_switch_device_mode: Fz.Converter<"genBasic", undefined, ["attributeReport", "readResponse"]>;
export declare const CCTSwitch_D0001_levelctrl: Fz.Converter<"genLevelCtrl", undefined, [
    "commandMoveToLevel",
    "commandMoveToLevelWithOnOff",
    "commandMove",
    "commandStop"
]>;
export declare const CCTSwitch_D0001_lighting: Fz.Converter<"lightingColorCtrl", undefined, ["commandMoveToColorTemp", "commandMoveColorTemp"]>;
export declare const hue_tap: Fz.Converter<"greenPower", undefined, ["commandNotification", "commandCommissioningNotification"]>;
export declare const tuya_relay_din_led_indicator: Fz.Converter<"genOnOff", undefined, ["attributeReport", "readResponse"]>;
...
export declare const schneider_temperature: Fz.Converter<"msTemperatureMeasurement", undefined, ["attributeReport", "readResponse"]>;
...
export declare const heiman_doorbell_button: Fz.Converter<"ssIasZone", undefined, "commandStatusChangeNotification">;
export declare const sihas_people_cnt: Fz.Converter<"genAnalogInput", undefined, ["attributeReport", "readResponse"]>;
export declare const sihas_action: Fz.Converter<"genOnOff", undefined, ["commandOn", "commandOff", "commandToggle"]>;
...
export declare const command_stop_move_raw: Fz.Converter<"lightingColorCtrl", undefined, "raw">;
export declare const led_on_motion: Fz.Converter<"ssIasZone", undefined, ["attributeReport", "readResponse"]>;
...
export declare const metering_datek: Fz.Converter<"seMetering", undefined, ["attributeReport", "readResponse"]>;
export declare const EKO09738_metering: Fz.Converter<"seMetering", undefined, ["attributeReport", "readResponse"]>;
...
export declare const SP600_power: Fz.Converter<"seMetering", undefined, ["attributeReport", "readResponse"]>;
export declare const eurotronic_thermostat: Fz.Converter<"hvacThermostat", undefined, ["attributeReport", "readResponse"]>;
export declare const ZM35HQ_attr: Fz.Converter<"ssIasZone", undefined, ["attributeReport", "readResponse"]>;
export declare const schneider_lighting_ballast_configuration: Fz.Converter<"lightingBallastCfg", undefined, ["attributeReport", "readResponse"]>;
export declare const TS110E: Fz.Converter<"genLevelCtrl", undefined, ["attributeReport", "readResponse"]>;
export declare const TS110E_light_type: Fz.Converter<"genLevelCtrl", undefined, ["attributeReport", "readResponse"]>;
export declare const TS110E_switch_type: Fz.Converter<"genLevelCtrl", undefined, ["attributeReport", "readResponse"]>;
