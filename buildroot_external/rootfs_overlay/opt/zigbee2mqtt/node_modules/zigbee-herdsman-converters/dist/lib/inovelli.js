...
const COMMON_DIMMER_ATTRIBUTES = {
    ...
    outputMode: {
        ...
        modelValues: {
            ...
            ["VZM35-SN" /* Model.VZM35 */]: { values: { "Ceiling Fan (3-Speed)": 0, "Exhaust Fan (On/Off)": 1 } },
        },
        dataType: zigbee_herdsman_1.Zcl.DataType.BOOLEAN,
...
const COMMON_DIMMABLE_LIGHT_ATTRIBUTES = {
    ...
    dimmingAlgorithm: {
        ...
        addedInFirmware: { ["VZM31-SN" /* Model.VZM31 */]: [3, 5] },
        min: 0,
        max: 1,
    ...
    dumbDetectionLevel: {
        ID: 165,
        dataType: zigbee_herdsman_1.Zcl.DataType.UINT8,
        addedInFirmware: { ["VZM31-SN" /* Model.VZM31 */]: [3, 7] },
        min: 0,
        max: 4,
...
const tzLocal = {
    inovelli_parameters: (attributes, cluster, model) => ({
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            const payload = {
                [attributes[key].ID]: {
                    value: attributes[key].displayType === "enum" ? valueMap?.[value] : value,
