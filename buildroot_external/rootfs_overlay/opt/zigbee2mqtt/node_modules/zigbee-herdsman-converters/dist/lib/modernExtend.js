...
function genericMeter(args = {}) {
    ...
    if (args.threePhase === true) {
        ...
        if (args.voltage !== false) {
            exposes.push(exposes_1.presets.voltage_phase_b().withAccess(exposes_1.access.STATE_GET), exposes_1.presets.voltage_phase_c().withAccess(exposes_1.access.STATE_GET));
