...
class Device extends entity_1.default {
    ...
    #waitForOtaCommand(endpointId, commandId, transactionSequenceNumber, timeout) {
        const waiter = entity_1.default.adapter.waitFor(this.networkAddress, endpointId, Zcl.FrameType.SPECIFIC, Zcl.Direction.CLIENT_TO_SERVER, transactionSequenceNumber, GEN_OTA_CLUSTER_ID, commandId, timeout);
